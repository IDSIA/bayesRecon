...
In particular we show how to replicate the main experiment of the paper,  where we  reconcile  base forecast constituted by  negative binomial distributions. 

# Data and base forecasts


We consider time series of extreme market  events 
for five economic sectors in the period 2005-2018 (3508 trading days).  The economic sectors are: Financial (FIN), Information and Communication Technology (ICT), Manufacturing (MFG), Energy (ENG), and Trade (TRD). 
We count the number of extreme market  events in each sector,
obtaining five daily time series of counts.
See the paper for more details about this data set.
...
using the model by {agosto2022multivariate}. **fix citation**
