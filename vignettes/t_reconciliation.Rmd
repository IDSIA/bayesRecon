...
dens_ch <- dinvgamma(x_ch, shape = shape_ch, rate = rate_ch)
...
dens_gr <- dinvgamma(x_gr, shape = shape_gr, rate = rate_gr)
```
...
```{r density plot, echo=FALSE, eval=TRUE, dpi=300, out.width = "100%", fig.align='center', fig.cap="**Figure 3**: Density of the posterior standard deviation of the forecasts for the time series CH and GR.", fig.dim = c(8, 4), warning=FALSE}
...
```{r plot densities, echo=FALSE, eval=TRUE, dpi=300, out.width = "100%", fig.align='center', fig.cap="**Figure 4**: Density of the posterior correlation between CH and GR obtained with t-Rec. The vertical dashed line indicates the point estimate obtained with MinT.", fig.dim = c(8, 4), warning=FALSE}
