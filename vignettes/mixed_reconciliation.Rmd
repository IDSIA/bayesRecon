...
For this reason, we introduced top down conditioning (TD-cond; see [@zambon2024mixed], Sec. 5) as a more reliable approach for reconciliation with mixed variables in high dimensions.
