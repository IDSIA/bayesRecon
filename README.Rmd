...
## News
:boom: [2026-03-05] Version 1.0 of the package. Major update on the API of the package, added `reconc_t` that implements the method t-Rec. 
...
Carrara, C., Corani, G., Azzimonti, D., Zambon, L. (2025). *Modeling the uncertainty on the covariance matrix for probabilistic forecast reconciliation*. arXiv preprint arXiv:2506.19554.
