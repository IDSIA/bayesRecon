...
bayesRecon is a package for probabilistic reconciliation of hierarchical time series forecasts.
Probabilistic reconciliation is performed via conditioning.
...
Since there is a positive incoherence in the forecasts ($\lambda_Y > \lambda_1+\lambda_2$), the mean of the bottom reconciled forecast increases. We show below this behavior for $S_1$.  
...
The blue circles represent the probability mass function of a Poisson with parameter $\lambda_1$ plotted on top of the histogram of the reconciled bottom forecasts for $S_1$. Note how the histogram is shifted to the right.
