...
*Probabilistic Reconciliation of Hierarchical Forecast via Bayes’ Rule*.  [DOI](https://doi.org/10.1007/978-3-030-67664-3_13)
...
*Efficient probabilistic reconciliation of forecasts for real-valued and count time series*. [DOI](https://doi.org/10.1007/s11222-023-10343-y)

Zambon, L., Agosto, A., Giudici, P., Corani, G. (2024). 
*Properties of the reconciled distributions for Gaussian and count forecasts*. [DOI](https://doi.org/10.1016/j.ijforecast.2023.12.004)
