...
#> Time taken by Gaussian reconciliation:  0.27 s
```
...
#> Computational time for Mix-cond reconciliation:  9.52 s
```
...
#> Computational time for TD-cond reconciliation:  10.63 s
```

## Comparison

The computational time required for the Gaussian reconciliation is 0.27
seconds, Mix-cond requires 9.52 seconds and TD-cond requires 10.63
seconds.
