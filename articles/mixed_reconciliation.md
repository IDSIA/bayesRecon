...
#> Computational time for Mix-cond reconciliation:  9.82 s
```
...
#> Computational time for TD-cond reconciliation:  10.7 s
```

## Comparison

The computational time required for the Gaussian reconciliation is 0.3
seconds, Mix-cond requires 9.82 seconds and TD-cond requires 10.7
seconds.
